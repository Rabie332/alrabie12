    ...
    ***************************************************************************** */ var B =
    ...
    for (
        var f = function (A, e) {
            ...
            c = typeof Uint8Array === "undefined" ? [] : new Uint8Array(256),
            n = 0;
        n < e.length;
        n++
    )
        ...
        var e = (r = (function (A, B) {
                ...
                return (
                    A.forEach(function (A, e) {
                        var t = j.get(A);
                        if (
                            (t > 50 ? (s.push(!0), (t -= 50)) : s.push(!1),
                            ["normal", "auto", "loose"].indexOf(B) !== -1 &&
                                [8208, 8211, 12316, 12448].indexOf(A) !== -1)
                        )
                        ...
                        if (e === 0) return n.push(e), r.push(V);
                        t = r[e - 1];
        ...
        return [
            ...
            (B =
                A.wordBreak === "break-all" || A.wordBreak === "break-word"
                    ? B.map(function (A) {
                          return [S, V, Z].indexOf(A) !== -1 ? X : A;
                      })
                    : B),
            A.wordBreak === "keep-all"
                ? r.map(function (A, e) {
                      return A && t[e] >= 19968 && t[e] <= 40959;
                  })
                : void 0,
        ];
    }
                ...
                p[5] === 2
                    ...
                    : ((F = p),
                      ...
                      F.slice
                          ? F.slice(E, u)
                          : new Uint32Array(
                                Array.prototype.slice.call(F, E, u)
                            ))),
                ...
                for (
                    ...
                    (A = (function (A, e, t, B, r) {
                        ...
                        var s = n - 1,
                            ...
                            r = e[o];
                        if (i === 2 && r === 3) return q;
                        if ($.indexOf(i) !== -1) return "!";
                        if ($.indexOf(r) !== -1) return q;
                        if (AA.indexOf(r) !== -1) return q;
                        if (U(n, e) === 8) return "÷";
                        if (j.get(A[n]) === 11) return q;
                        if ((i === k || i === R) && j.get(A[o]) === 11)
                            return q;
                        if (i === 7 || r === 7) return q;
                        if (i === 9) return q;
                        if ([I, y, K].indexOf(i) === -1 && r === 9) return q;
                        if ([m, L, b, M, O].indexOf(r) !== -1) return q;
                        if (U(n, e) === x) return q;
                        if (w(23, x, n, e)) return q;
                        if (w([m, L], v, n, e)) return q;
                        if (w(12, 12, n, e)) return q;
                        if (i === I) return "÷";
                        if (i === 23 || r === 23) return q;
                        if (r === 16 || i === 16) return "÷";
                        if ([y, K, v].indexOf(r) !== -1 || i === 14) return q;
                        if (B === 36 && rA.indexOf(i) !== -1) return q;
                        if (i === O && r === 36) return q;
                        if (r === D) return q;
                        if (
                            (z.indexOf(r) !== -1 && i === S) ||
                            (z.indexOf(i) !== -1 && r === S)
                            ...
                            return q;
                        if (
                            (i === G && [X, k, R].indexOf(r) !== -1) ||
                            ([X, k, R].indexOf(i) !== -1 && r === T)
                        )
                            return q;
                        if (
                            (z.indexOf(i) !== -1 && eA.indexOf(r) !== -1) ||
                            (eA.indexOf(i) !== -1 && z.indexOf(r) !== -1)
                        )
                            return q;
                        if (
                            ([G, T].indexOf(i) !== -1 &&
                                (r === S ||
                                    ([x, K].indexOf(r) !== -1 &&
                                        e[1 + o] === S))) ||
                            ([x, K].indexOf(i) !== -1 && r === S) ||
                            (i === S && [S, O, M].indexOf(r) !== -1)
                        )
                            return q;
                        if ([S, O, M, m, L].indexOf(r) !== -1)
                            for (var Q = n; Q >= 0; ) {
                                if ((c = e[Q]) === S) return q;
                                if ([O, M].indexOf(c) === -1) break;
                                Q--;
                            }
                        if ([G, T].indexOf(r) !== -1)
                            for (
                                var c, Q = [m, L].indexOf(i) !== -1 ? s : n;
                                Q >= 0;
                        ...
                        if (
                            ...
                            return q;
                        if (z.indexOf(i) !== -1 && z.indexOf(r) !== -1)
                            return q;
                        if (i === M && z.indexOf(r) !== -1) return q;
                        if (
                            (z.concat(S).indexOf(i) !== -1 &&
                                r === x &&
                                _.indexOf(A[o]) === -1) ||
                            (z.concat(S).indexOf(r) !== -1 && i === L)
                        )
                            return q;
                        if (i === 41 && r === 41) {
                            for (var a = t[n], g = 1; a > 0 && e[--a] === 41; )
                                g++;
                            if (g % 2 != 0) return q;
                        }
                        return i === k && r === R ? q : "÷";
    ...
    function UA(A, e, t) {
        return A === 45
            ? aA(e) || wA(e, t)
            : Boolean(aA(A)) || (A === 92 && e !== 10);
    }
    function CA(A, e, t) {
        return A === 43 || A === 45
            ? Boolean(iA(e)) || (e === 46 && iA(t))
            : iA(A === 46 ? e : A);
    }
    var lA = { type: 2 },
        uA = { type: 3 },
        ...
        GA =
            ...
            (OA.prototype.consumeToken = function () {
                ...
                switch (A) {
                    ...
                    case 47:
                        if (this.peekCodePoint(0) === 42)
                            for (this.consumeCodePoint(); ; ) {
                                ...
                                if (
                                    s === 42 &&
                                    (s = this.consumeCodePoint()) === 47
                                )
                                    return this.consumeToken();
                                if (s === -1) return this.consumeToken();
                            }
                        break;
                    case 58:
                        return DA;
                    ...
                    case 60:
                        if (
                            this.peekCodePoint(0) === 33 &&
                            this.peekCodePoint(1) === 45 &&
                            this.peekCodePoint(2) === 45
                        )
                            return (
                                this.consumeCodePoint(),
                                this.consumeCodePoint(),
            ...
            (OA.prototype.consumeUnicodeRangeToken = function () {
                ...
                if (this.peekCodePoint(0) === 45 && QA(this.peekCodePoint(1))) {
                    this.consumeCodePoint();
                    for (
            ...
            (OA.prototype.consumeIdentLikeToken = function () {
                ...
                return A.toLowerCase() === "url" && this.peekCodePoint(0) === 40
                    ? (this.consumeCodePoint(), this.consumeUrlToken())
                    : this.peekCodePoint(0) === 40
            ...
            (OA.prototype.consumeUrlToken = function () {
                ...
                if (t === 39 || t === 34) {
                    ...
                    return t.type === 0 &&
                        ...
                        this.peekCodePoint(0) === -1 ||
                            this.peekCodePoint(0) === 41)
                        ? (this.consumeCodePoint(),
            ...
            (OA.prototype.consumeStringToken = function (A) {
                for (var e = "", t = 0; ; ) {
                    ...
                    if (r === 10) return this._value.splice(0, t), mA;
                    r !== 92 ||
                        ((B = this._value[t + 1]) !== -1 &&
                            void 0 !== B &&
                            (B === 10
            ...
            (OA.prototype.consumeNumber = function () {
                var A = [],
                    e = 4;
                for (
                    ((t = this.peekCodePoint(0)) !== 43 && t !== 45) ||
                ...
                return [
                    (function (A) {
                        ...
                        return (
                            t * (r + o * Math.pow(10, -s)) * Math.pow(10, i * c)
                        );
                    })(A),
                    e,
                ];
    ...
    var VA =
        ...
        (kA.prototype.consumeFunction = function (A) {
            for (var e = { name: A.value, values: [], type: 18 }; ; ) {
                ...
                if (t.type === 32 || t.type === 3) return e;
                this.reconsumeToken(t),
                    e.values.push(this.consumeComponentValue());
            }
        }),
    ...
    function ue(A, t) {
        var e = A[0],
            B = A[A.length - 1];
        e.stop === null && (e.stop = ne), B.stop === null && (B.stop = oe);
    ...
    var fe = function (A, e) {
            var t = e.filter(WA),
                ...
                n = t[2],
                e = t[3],
                t = (B.type === 17 ? ce(B.number) : Qe(A, B)) / (2 * Math.PI),
                A = qA(r) ? r.number / 100 : 0,
                B = qA(n) ? n.number / 100 : 0,
                r = void 0 !== e && qA(e) ? ie(e, 1) : 1;
            if (A == 0) return ge(255 * B, 255 * B, 255 * B, 1);
                ...
                return (
                    ZA(A).forEach(function (A, e) {
                        var t,
                            A = A[0];
                        if (e === 0) {
                            if (NA(A) && A.value === "linear")
                                return void (n = 1);
                            if (NA(A) && A.value === "radial")
                                return void (n = 2);
                        }
                        A.type === 18 &&
                            (A.name === "from"
                                ? ((t = ae(B, A.values[0])),
                                  r.push({ stop: ne, color: t }))
                                : A.name === "to"
                                ? ((t = ae(B, A.values[0])),
                                  r.push({ stop: oe, color: t }))
                                : A.name !== "color-stop" ||
                                  ((A = A.values.filter(WA)).length === 2 &&
                                      ((t = ae(B, A[1])),
                                      (A = A[0]),
                                      PA(A) &&
                                          r.push({
    ...
    var Re,
        ...
        wt = {
            ...
            type: 2,
            parse: function (A, e) {
                return e !== "strict" ? Re.NORMAL : Re.STRICT;
            },
        },
        Ut = {
            name: "line-height",
        ...
        Ct = {
            ...
            prefix: !1,
            parse: function (A, e) {
                return e.type === 20 && e.value === "none" ? null : ve(A, e);
            },
        },
        lt = {
        ...
        xt = {
            ...
            matrix3d: function (A) {
                ...
                var s = e[12],
                    A = e[13];
                return (
                    e[14], e[15], e.length === 16 ? [t, B, r, n, s, A] : null
                );
            },
        },
    ...
    function sB(A, e) {
        ...
        (this.overflowX = t[0]),
            ...
            (this.textDecorationColor = QB(
                A,
                Nt,
                (t = e.textDecorationColor) !== null && void 0 !== t
                    ? t
                    : e.color
            )),
            (this.textDecorationLine = QB(
                A,
                Xt,
                (t = e.textDecorationLine) !== null && void 0 !== t
                    ? t
                    : e.textDecoration
            )),
    ...
    for (
        var oB = function (A, e) {
            ...
            QB = function (A, e, t) {
                var B = new GA(),
                    t = t != null ? t.toString() : e.initialValue;
                B.write(t);
                var r = new VA(B.read());
                switch (e.type) {
                    case 2:
            ...
            gB =
                "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
            wB = typeof Uint8Array === "undefined" ? [] : new Uint8Array(256),
            UB = 0;
        UB < gB.length;
        UB++
    )
    ...
    for (
        var FB =
                "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
            hB = typeof Uint8Array === "undefined" ? [] : new Uint8Array(256),
            dB = 0;
        dB < FB.length;
        dB++
    )
                ...
                for (
                    ...
                    (A = (function (A, e) {
                        var t = e - 2,
                            ...
                            r = A[e - 1],
                            e = A[e];
                        if (r === 2 && e === 3) return TB;
                        if (r === 2 || r === 3 || r === 4) return "÷";
                        if (e === 2 || e === 3 || e === 4) return "÷";
                        if (r === DB && [DB, vB, xB, MB].indexOf(e) !== -1)
                            return TB;
                        if (!((r !== xB && r !== vB) || (e !== vB && e !== 10)))
                            return TB;
                        if ((r === MB || r === 10) && e === 10) return TB;
                        if (e === 13 || e === 5) return TB;
                        if (e === 7) return TB;
                        if (r === 1) return TB;
                        if (r === 13 && e === 14) {
                            for (; B === 5; ) B = A[--t];
    ...
    var IB,
                ...
                mB[5] === 2
                    ...
                    : ((KB = mB),
                      ...
                      KB.slice
                          ? KB.slice(LB, yB)
                          : new Uint32Array(
                                Array.prototype.slice.call(KB, LB, yB)
                            ))),
        ...
        VB = {
                ...
                var A = (function (A) {
                    if (A.createRange) {
                        ...
                        if (e.getBoundingClientRect) {
                            ...
                            if ((A.body.removeChild(t), e === 123)) return !0;
                        }
                    }
                    return !1;
                })(document);
            ...
            get SUPPORT_CORS_XHR() {
                ...
                return (
                    Object.defineProperty(VB, "SUPPORT_CORS_XHR", { value: A }),
                    A
                );
            },
        },
        ...
        XB = function (A, e) {
            return e.letterSpacing !== 0 ? pB(A) : YB(A, e);
        },
        ...
        WB = function (A, e, t) {
            ...
            (this.text = ZB(e.data, t.textTransform)),
                (this.textBounds =
                    ...
                    A.forEach(function (A) {
                        var e;
                        r.textDecorationLine.length || A.trim().length > 0
                            ? VB.SUPPORT_RANGE_BOUNDS
    ...
    function cr(A, e) {
        ...
        return (
            (A.start = e.start),
            (A.reversed = typeof e.reversed === "boolean" && !0 === e.reversed),
            A
        );
    }
    var ar,
                    ...
                    : Gr(r) &&
                      (qr(r) && r.assignedNodes
                          ...
                          : (n = vr(e, r)).styles.isVisible() &&
                            ...
                            br.indexOf(r.tagName) !== -1 && (n.flags |= 8),
                            t.elements.push(n),
                            r.slot,
                            r.shadowRoot
    ...
    function Bn(A, e, t, B, r, n) {
        if (A < -9999 || A > 9999) return an(A, 4, r.length > 0);
        var s = Math.abs(A),
            o = r;
        if (s === 0) return e[0] + o;
    ...
    var rn,
        ...
        wn =
                ...
                try {
                    ...
                    if (e && e.cssRules) {
                        var t = [].slice
                                .call(e.cssRules, 0)
                                .reduce(function (A, e) {
                                    return e && typeof e.cssText === "string"
                                        ? A + e.cssText
                                        : A;
                                }, ""),
                            B = A.cloneNode(!1);
            ...
            (Un.destroy = function (A) {
                return (
                    Boolean(A.parentNode) && (A.parentNode.removeChild(A), !0)
                );
            }),
            Un);
    function Un(A, e, t) {
    ...
    var xn = /^data:image\/svg\+xml/i,
        ...
        kn = function (A) {
            return A.substr(-3).toLowerCase() === "svg" || xn.test(A);
        },
        Rn =
        ...
        rs =
            ((ns.prototype.getEffects = function (e) {
                for (
                    ...
                    A || t.container.styles.position !== 0 || !t.parent
                        ? (B.unshift.apply(B, s),
                          (A =
    ...
    function ns(A, e) {
        ...
        (this.container = A),
            ...
            this.container.styles.overflowX !== 0 &&
                ((t = _n(this.curves)),
                (B = qn(this.curves)),
                zn(t, B)
    ...
    function Qs(A, e, t) {
        var B =
                ...
                (n = A),
                r === 0 ? n.bounds : (r === 2 ? is : os)(n)),
            r =
                ((s = us(A.styles.backgroundClip, e)),
                (o = A),
                s === 0 ? o.bounds : (s === 2 ? is : os)(o)),
    ...
    var Hs,
        ...
        ps =
            ...
            (Es.prototype.applyEffect = function (A) {
                this.ctx.save(),
                    A.type === 2 && (this.ctx.globalAlpha = A.opacity),
                    A.type === 0 &&
            ...
            (Es.prototype.createFontStyle = function (A) {
                var e = A.fontVariant
                    ...
                    t = A.fontFamily.join(", "),
                    B = RA(A.fontSize)
                        ? String(A.fontSize.number) + A.fontSize.unit
                        ...
                        switch (A.label) {
                            ...
                            case 14:
                                ...
                                if (e.styles.listStyleImage === null)
                                    return [3, 19];
                                if ((c = e.styles.listStyleImage).type !== 0)
                                    return [3, 18];
                            ...
                            case 19:
                                w.listValue &&
                                    ...
                                    (g = new d(
                                        ...
                                        e.bounds.width,
                                        ke(B.lineHeight, B.fontSize.number) /
                                            2 +
                                            1
                                    )),
                                    this.renderTextWithLetterSpacing(
                    ...
                    return H(this, function (A) {
                        switch (A.label) {
                            ...
                            case 22:
                                (a = 0),
                                    (g =
                                        l.zeroOrAutoZIndexOrTransformedOrOpacity),
                                    (A.label = 23);
                            case 23:
                                return a < g.length
            ...
            (Es.prototype.formatPath = function (A) {
                ...
                A.forEach(function (A, e) {
                    ...
                    e === 0 ? B.ctx.moveTo(t.x, t.y) : B.ctx.lineTo(t.x, t.y),
                        Yn(A) &&
                            B.ctx.bezierCurveTo(
                                A.startControl.x,
                                A.startControl.y,
            ...
            (Es.prototype.resizeImage = function (A, e, t) {
                ...
                var B = (
                    (B = this.canvas.ownerDocument) !== null && void 0 !== B
                        ? B
                        : document
    ...
    function Ss(A, e) {
        (this.windowBounds = e),
            ...
            (this.cache =
                (e = A.cache) !== null && void 0 !== e ? e : new Dn(this, A));
    }
    typeof window !== "undefined" && Ln.setContext(window);
    var Ts = function (u, F) {
                    ...
                    switch (A.label) {
                        case 0:
                            ...
                            return (
                                ...
                                (c = {
                                    windowWidth:
                                        (c = F.windowWidth) !== null &&
                                        void 0 !== c
                                            ? c
                                            : t.innerWidth,
                                    windowHeight:
                                        (a = F.windowHeight) !== null &&
                                        void 0 !== a
                                            ? a
                                            : t.innerHeight,
                                    scrollX:
                                        (g = F.scrollX) !== null && void 0 !== g
                                            ? g
                                            : t.pageXOffset,
                                    scrollY:
                                        (w = F.scrollY) !== null && void 0 !== w
                                            ? w
                                            : t.pageYOffset,
                                }),
                                (a = new d(
                                ...
                                (g = new Ms(U, a)),
                                (c =
                                    (w = F.foreignObjectRendering) !== null &&
                                    void 0 !== w &&
                                    w),
                                (w = {
                                    allowTaint:
                            ...
                            (C = {
                                ...
                                y:
                                    ((C = F.y) !== null && void 0 !== C
                                        ...
                                        : 0) + o,
                                width:
                                    (C = F.width) !== null && void 0 !== C
                                        ? C
                                        : Math.ceil(r),
                                height:
                                    (C = F.height) !== null && void 0 !== C
                                        ? C
                                        : Math.ceil(n),
                            }),
                            c)
