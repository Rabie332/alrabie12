odoo.define("ks_dn_advance.ks_tv_dashboard", function (require) {
    ...
    KsDashboardNinja.include({
        jsLibs: [
            ...
            "/ks_dashboard_ninja/static/libs/js/Chart.bundle.min.js",
            "/ks_dashboard_ninja/static/libs/js/gridstack-h5.js",
            //            '/ks_dashboard_ninja/static/lib/js/gridstack.jQueryUI.min.js',
            "/ks_dashboard_ninja/static/libs/js/chartjs-plugin-datalabels.js",
            "/ks_dashboard_ninja/static/libs/js/pdfmake.min.js",
            "/ks_dashboard_ninja/static/libs/js/vfs_fonts.js",
            "ks_dn_advance/static/libs/js/print.min.js",
            "ks_dn_advance/static/libs/js/pdf.min.js",
        ],
        ...
        ks_dash_print: function (id) {
            ...
            setTimeout(function () {
                ...
                window.scrollTo(0, 0);
                html2canvas(document.querySelector("#ks_dash1"), {
                    scale: 2,
                }).then((canvas) => {
                    ...
                    var ratio =
                        KsimageWidth / KsimageHeight >=
                        KspageWidth / KspageHeight
                            ? KspageWidth / KsimageWidth
                            : KspageHeight / KsimageHeight;
                    pdf.addImage(
                        ks_image_date,
                        "JPEG",
                        0,
        ...
        _ksRenderNoItemView: function () {
            ...
            self.$el
                .find(".ks_dashboard_print_pdf")
                .addClass("ks_hide_display");
        ...
        _ksSortAscOrder: function (e) {
            ...
            if (store == "true") {
                self._rpc({
                    ...
                    args: [[parseInt(item_id)], ks_domain],
                    context: context,
                }).then(function (result) {
                    if (result) {
                        var list_view_data = result;
                        var $listBody = self._ksListViewBody(
                            list_view_data,
                            item_id
                        );
                        $(
                            self.$el
                                .find(".grid-stack-item[gs-id=" + item_id + "]")
                                .children()[0]
                        )
                            .find(".ks_table_body")
                            .empty();
                ...
                $(
                    ...
                    .find(".ks_sort_up[data-fields=" + field + "]")
                    .removeClass("ks_plus");
                $(
                    self.$el
                        .find(".grid-stack-item[gs-id=" + item_id + "]")
                    ...
                    .find(".ks_sort_down[data-fields=" + field + "]")
                    .addClass("ks_plus");
                $(
                    self.$el
                        .find(".grid-stack-item[gs-id=" + item_id + "]")
                    ...
                    .find(".list_header[data-fields=" + field + "]")
                    .removeClass("ks_dn_asc");
                $(
                    self.$el
                        .find(".grid-stack-item[gs-id=" + item_id + "]")
                        .children()[0]
                                ...
                                if (
                                    ...
                                    list_view_data.data_rows[j].data[index] =
                                        field_utils.format.date(
                                            moment(moment(date).utc(false)._d),
                                            {},
                                            {
                                                timezone: false,
                                            }
        ...
        rendertvDashboard: function () {
            ...
            self.$el
                .find(".ks_dashboard_main_content")
                .append(this.container_owl);
        ...
        ksRenderTvDashboardItems: function (items) {
            ...
            for (var i = 0; i < items.length; i++) {
                if (items[i].ks_dashboard_item_type === "ks_tile") {
                    ...
                    if (
                        $(".grid-stack-item[gs-id=" + items[i].id + "]")
                            .find(".ks_card_header")
                            .find(".active")
                            .data()
                    ) {
                    ...
                    var item_view = self.renderTvTodoView(
                        items[i],
                        active_section_id,
                        self.grid
                    );
        ...
        renderTvTodoView: function (item, active_section_id) {
            ...
            var ks_header_color = self._ks_get_rgba_format(
                item.ks_header_bg_color
            );
            var ks_font_color = self._ks_get_rgba_format(item.ks_font_color);
            var ks_rgba_button_color = self._ks_get_rgba_format(
                item.ks_button_color
            );
            var $ksItemContainer = self.ksRenderToDoView(
                item,
                (ks_tv_play = true)
            );
            var $ks_gridstack_container = $(
                QWeb.render("ks_gridstack_todo_tv_view_container", {
            ...
            $ks_gridstack_container
                .find(".ks_card_header")
                .addClass("ks_bg_to_color")
                .css({ "background-color": ks_header_color });
            $ks_gridstack_container
                .find(".ks_card_header")
                .addClass("ks_bg_to_color")
                .css({ color: ks_font_color + " !important" });
            $ks_gridstack_container
                .find(".ks_dna_li_tab")
                .addClass("ks_bg_to_color")
                .css({ color: ks_font_color + " !important" });
            ...
            if (active_section_id) {
                ...
                $ks_gridstack_container
                    .find(".ks_card_header")
                    .find(
                        ".nav-link[data-section-id=" + active_section_id + "]"
                    )
                    .addClass("active");
                $ksItemContainer.find(".ks_tab_section").removeClass("active");
                $ksItemContainer
                    .find(
                        ".ks_tab_section[data-section-id=" +
                            active_section_id +
                            "]"
                    )
                    .addClass("active");
            ...
            $ks_gridstack_container
                .find(".ks_to_do_card_body")
                .append($ksItemContainer);
        ...
        _renderTiles: function () {
            ...
            var $kscontainer = $(
                '<div class="d-flex align-items-center justify-content-center flex-column h-100 ks_tv_item">'
            );
        ...
        renderKpi: function (item, grid) {
            ...
            if (isNaN(kpi_data[0].record_data)) {
                ...
                var count_value = KsGlobalFunction._onKsGlobalFormatter(
            ...
            if (self.ksAllowItemClick) {
                ...
                if (e.target.title != "Customize Item") {
                    ...
                    if (
                        ...
                        item_data.ks_data_calculation_type === "custom"
                    ) {
                        if (item_data.action) {
        ...
        _renderGraph: function (item) {
            ...
            if (item.ks_data_calculation_type === "query") {
                $(
                    self.$el
                        .find(".grid-stack-item[gs-id=" + item.id + "]")
                        .children()[0]
                )
        ...
        startTvDashboard: function (e) {
            ...
            var self = this;
            var speed = self.ks_dashboard_data.ks_croessel_speed
                ? parseInt(self.ks_dashboard_data.ks_croessel_speed)
                : 5000;
            ...
            for (var i = 0; i < ids.length; i++) {
                ...
                if (item_data.ks_dashboard_item_type == "ks_list_view") {
                    var item_view = self.$el.find(
                        ".grid-stack-item[gs-id=" + item_data.id + "]"
                    );
                    ...
                    var item_view = self._ksRenderDashboardTile(item_data);
                    self.$el
                        .find(".grid-stack-item[gs-id=" + item_data.id + "]")
                        ...
                        for (
                            ...
                            if (date) {
                                if (
                                    ...
                                    (list_view_data.data_rows[j].data[index] =
                                        moment(new Date(date + " UTC")).format(
        ...
        renderTvListView: function (item) {
            ...
            var $ks_gridstack_container = $(
                QWeb.render("ks_gridstack_list_tv_view_container", {
                    ks_chart_title: item_title,
        ...
        _renderListView: function (item, grid) {
            ...
            if (item_id in self.gridstackConfig) {
                grid.addWidget($ks_gridstack_container[0], {
                    x: self.gridstackConfig[item_id].x,
                    y: self.gridstackConfig[item_id].y,
                    w: self.gridstackConfig[item_id].w,
                    h: self.gridstackConfig[item_id].h,
                    autoPosition: false,
                    minW: 3,
                    maxW: null,
                    minH: 3,
        ...
        _renderTvGraph: function (item) {
            ...
            var $ks_gridstack_container = $(
                QWeb.render("ks_gridstack_tv_container", {
        ...
        _rendertvChart($ks_gridstack_container, item) {
            ...
            $ks_gridstack_container
                .find(".ks_color_pallate")
                .data({ chartType: chart_type, chartFamily: chart_family });
