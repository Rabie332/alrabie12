...
!(function (t, e) {
                        ...
                        !(
                            ...
                            (this._parent &&
                                (e = [].slice
                                    ...
                                    .filter(function (t) {
                                        return typeof o._config.parent ===
                                            "string"
    ...
    function nt(t) {
        return t.parentNode !== null ? nt(t.parentNode) : t;
    }
    function it(t, e) {
        ...
        if ((t !== l && e !== l) || i.contains(o))
            return (s = (a = l).nodeName) === "BODY" ||
                (s !== "HTML" && et(a.firstElementChild) !== a)
                ? et(l)
                : l;
        var u = nt(t);
    ...
    function pt(t) {
        ...
        var o = {
            ...
            r = t.nodeName === "HTML" ? lt(t.ownerDocument) : {},
    ...
    function _t(t) {
        ...
        if (K(t, "position") === "fixed") return !0;
        var n = X(t);
        return Boolean(n) && _t(n);
    }
    function vt(t) {
        if (!t || !t.parentElement || tt()) return document.documentElement;
        for (var e = t.parentElement; e && K(e, "transform") === "none"; )
            e = e.parentElement;
    ...
    function bt(t, e, n, i) {
        var o = arguments.length > 4 && void 0 !== arguments[4] && arguments[4],
            r = { top: 0, left: 0 },
            a = o ? vt(t) : it(t, $(e));
        if (i === "viewport") r = gt(a, o);
        else {
            var s = void 0;
            i === "scrollParent"
                ? (s = G(X(e))).nodeName === "BODY" &&
                  (s = t.ownerDocument.documentElement)
                : (s = i === "window" ? t.ownerDocument.documentElement : i);
            var l = mt(s, a, o);
            if (s.nodeName !== "HTML" || _t(a)) r = l;
            else {
    ...
    (Vt.Utils = (typeof window !== "undefined" ? window : global).PopperUtils),
        (Vt.placements = Bt),
        (Vt.Defaults = Ut);
    var Yt = Vt,
        zt = "dropdown",
                ...
                (e.show = function (e) {
                    if (
                        ...
                        if (
                            ...
                            "ontouchstart" in document.documentElement &&
                                i.default(r).closest(".navbar-nav").length ===
                                    0 &&
                                i
                ...
                (e._enforceFocus = function () {
                    ...
                    i.default(document)
                        ...
                        .on(_e, function (e) {
                            document !== e.target &&
                                t._element !== e.target &&
                                i.default(t._element).has(e.target).length ===
                                    0 &&
                                t._element.focus();
                        });
                }),
            ...
            return (
                ...
                (e._enter = function (t, e) {
                    ...
                    (e = e || i.default(t.currentTarget).data(n)) ||
                        ...
                        t &&
                            (e._activeTrigger[t.type === "focusin" ? qe : Me] =
                                !0),
                ...
                (e._leave = function (t, e) {
                    ...
                    (e = e || i.default(t.currentTarget).data(n)) ||
                        ...
                        i.default(t.currentTarget).data(n, e)),
                        t &&
                            (e._activeTrigger[t.type === "focusout" ? qe : Me] =
                                !1),
