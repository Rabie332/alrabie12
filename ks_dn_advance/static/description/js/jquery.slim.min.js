...
!(function (e, t) {
        ...
        E.extend({
            ...
            when: function (e) {
                ...
                if (
                    ...
                    o.state() === "pending" || b(i[t] && i[t].then))
                )
                    return o.then();
    ...
    (E.fn.ready = function (e) {
        ...
        (w.readyState !== "loading" && !w.documentElement.doScroll)
            ...
            data: function (n, e) {
                ...
                if (void 0 === n) {
                    if (
                        this.length &&
                        ((i = G.get(o)),
                        o.nodeType === 1 && !Y.get(o, "hasDataAttrs"))
                    ) {
                        t = a.length;
                        while (t--)
                            a[t] &&
    ...
    var ae = function (e, t) {
        return (
            ...
            (e.style.display === "" && ie(e) && E.css(e, "display") === "none")
        );
    };
    var se = {};
    function ue(e, t) {
    ...
    (le = w.createDocumentFragment().appendChild(w.createElement("div"))),
        ...
        (m.noCloneChecked = Boolean(le.cloneNode(!0).lastChild.defaultValue)),
        (le.innerHTML = "<option></option>"),
        (m.option = Boolean(le.lastChild));
    var he = {
        thead: [1, "<table>", "</table>"],
    ...
    function Pe(n, r, i, o) {
        ...
        if (
            h ||
            (f > 1 && typeof p === "string" && !m.checkClone && ke.test(p))
        )
    ...
    E.extend({
        ...
        E.each(["height", "width"], function (e, u) {
            E.cssHooks[u] = {
                ...
                set: function (e, t, n) {
                    var r,
                        i = Re(e),
                        o = !m.scrollboxSize() && i.position === "absolute",
                        a =
                            (o || n) &&
                            E.css(e, "boxSizing", !1, i) === "border-box",
                        s = n ? Ze(e, u, n, a, i) : 0;
                    return (
                        a &&
                            o &&
        ...
        E.each({ margin: "", padding: "", border: "Width" }, function (i, o) {
            (E.cssHooks[i + o] = {
                ...
                i !== "margin" && (E.cssHooks[i + o].set = Je);
        }),
        E.fn.extend({
            css: function (e, t) {
                return $(
    ...
    E.fn.extend({
        ...
        E.extend({
            ...
            attrHooks: {
                type: {
                    set: function (e, t) {
                        if (!m.radioValue && t === "radio" && S(e, "input")) {
                            var n = e.value;
                            return (
    ...
    (E.proxy = function (e, t) {
        ...
        (E.trim = function (e) {
            return e == null ? "" : String(e).replace(yt, "");
        }),
    ...
    return (
        ...
        typeof e === "undefined" && (g.jQuery = g.$ = E),
        E
    );
});
