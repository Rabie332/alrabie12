...
class KsDashboardNinjaBoardItemAction(models.TransientModel):
    ...
    ks_dashboard_item_ids = fields.Many2many(
        "ks_dashboard_ninja.item", string="Dashboard Items"
    )
    ...
    ks_dashboard_ninja_ids = fields.Many2many(
        "ks_dashboard_ninja.board", string="Select Dashboards"
    )
