...
(function (factory) {
    ...
    var defaultOpts = {
        ...
        spectrums = [],
        IE = Boolean(/msie/i.exec(window.navigator.userAgent)),
        rgbaSupport = (function () {
            function contains(str, substr) {
                return Boolean(~String(str).indexOf(substr));
            }
    ...
    (function () {
        ...
        function stringInputToObject(color) {
            ...
            if ((match = matchers.hex3.exec(color))) {
                return {
                    r: parseIntFromHex(String(match[1]) + match[1]),
                    g: parseIntFromHex(String(match[2]) + match[2]),
                    b: parseIntFromHex(String(match[3]) + match[3]),
                    format: named ? "name" : "hex",
                };
            }
