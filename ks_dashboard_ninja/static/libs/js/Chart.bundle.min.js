...
!(function (t, e) {
    ...
    var I = S,
        ...
        F = {
            ...
            hexString: function (t, e) {
                var e = void 0 !== e && t.length === 3 ? e : t[3];
                return (
                    "#" +
                    H(t[0]) +
                    H(t[1]) +
    ...
    function R(t) {
        if (t) {
            ...
            return (i = i || i == 0 ? V(i, 0, 1) : 1), (e[3] = i), e;
        }
    }
    function L(t) {
        if (t) {
    ...
    var U,
        ...
        q = {
            ...
            isArray: function (t) {
                ...
                return (
                    e.substr(0, 7) === "[object" && e.substr(-6) === "Array]"
                );
            },
            isObject: function (t) {
                return (
    ...
    var lt = {
            toLineHeight: function (t, e) {
                var i = String(t).match(/^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/);
            ...
            resolve: function (t, e, i) {
                ...
                for (n = 0, a = t.length; n < a; ++n)
                    if (
                        void 0 !== (r = t[n]) &&
                        (void 0 !== e && typeof r === "function" && (r = r(e)),
    ...
    function Tt(t) {
        var e = this._view;
        return Boolean(e) && Math.abs(t - e.x) < e.radius + e.hitRadius;
    }
    ot._set("global", {
        elements: {
            point: {
    ...
    var Ot = gt.extend({
            ...
            inYRange: function (t) {
                var e = this._view;
                return Boolean(e) && Math.abs(t - e.y) < e.radius + e.hitRadius;
            },
            getCenterPoint: function () {
                var t = this._view;
                return { x: t.x, y: t.y };
    ...
    var jt = kt.extend({
            ...
            calculateBarValuePixels: function (t, e) {
                var i,
                    ...
                    h = d.isHorizontal(),
                    c = l.data.datasets,
                    f = Number(d.getRightValue(c[t].data[e])),
                ...
                if (m || (void 0 === m && void 0 !== p))
                    for (i = 0; i < t; ++i)
                        (n = l.getDatasetMeta(i)).bar &&
                            ...
                            ((a = Number(d.getRightValue(c[i].data[e]))),
                            ((f < 0 && a < 0) || (f >= 0 && a > 0)) &&
                                (v += a));
                return (
    ...
    var ie = kt.extend({
            ...
            updateElement: function (t, e, i) {
                ...
                (n = c.getPixelForValue(typeof d === "object" ? d : NaN, e, u)),
                    ...
                    (t._model = {
                        ...
                        steppedLine: Boolean(f) && f.steppedLine,
    ...
    function We(t, e, i) {
        ...
        !(function (t, e) {
            ...
            ut.each(Pe, function (e) {
                ...
                (i.reflow = Boolean(t.offsetParent)),
                t.classList.add(De);
        })(t, function () {
            if (s.resizer) {
                var e = t.parentNode;
    ...
    var Xe = gt.extend({
                    ...
                    for (e = 0, i = m.length; e < i; ++e)
                        w.push(
                            ...
                            (d = l._getValueScale()),
                            {
                                ...
                                label: u
                                    ? String(u.getLabelForIndex(o, s))
                                    : "",
                                value: d
                                    ? String(d.getLabelForIndex(o, s))
                                    : "",
                                index: o,
                                datasetIndex: s,
                                x: n._model.x,
            ...
            drawBackground: function (t, e, i, n) {
                ...
                i.beginPath(),
                    i.moveTo(o + d, s),
                    r === "top" && this.drawCaret(t, n),
                    i.lineTo(o + l - d, s),
                    i.quadraticCurveTo(o + l, s, o + l, s + d),
                    r === "center" && a === "right" && this.drawCaret(t, n),
                    i.lineTo(o + l, s + u - d),
                    i.quadraticCurveTo(o + l, s + u, o + l - d, s + u),
                    r === "bottom" && this.drawCaret(t, n),
                    i.lineTo(o + d, s + u),
                    i.quadraticCurveTo(o, s + u, o, s + u - d),
                    r === "center" && a === "left" && this.drawCaret(t, n),
                    i.lineTo(o, s + d),
    ...
    ut.extend(ni.prototype, {
        ...
        getElementsAtEventForMode: function (t, e, i) {
            var n = pe.modes[e];
            return typeof n === "function" ? n(this, t, i) : [];
        },
    ...
    var si = { _date: oi },
        li = {
            formatters: {
                values: function (t) {
                    return ut.isArray(t) ? t : String(t);
                },
    ...
    var fi = gt.extend({
        ...
        gi = fi.extend({
            ...
            getPixelForValue: function (t, e) {
                ...
                if (
                    (t != null && (i = n.isHorizontal() ? t.x : t.y),
    ...
    var yi = fi.extend({
        ...
        xi = yi.extend({
                    ...
                    ut.each(n, function (n, a) {
                        ...
                        i.isDatasetVisible(a) &&
                            ...
                            ut.each(n.data, function (i, n) {
                                var a = Number(t.getRightValue(i));
                                isNaN(a) ||
                                    o.data[n].hidden ||
                                    ((u[n] = u[n] || 0),
                                    (d[n] = d[n] || 0),
                    ...
                    ut.each(n, function (e, n) {
                        ...
                        i.isDatasetVisible(n) &&
                            ...
                            ut.each(e.data, function (e, i) {
                                var n = Number(t.getRightValue(e));
                                isNaN(n) ||
                                    a.data[i].hidden ||
                                    (t.min === null
                                        ? (t.min = n)
            ...
            getLabelForIndex: function (t, e) {
                return Number(
                    this.getRightValue(this.chart.data.datasets[e].data[t])
                );
            },
            getPixelForValue: function (t) {
                var e = this,
                    i = e.start,
                    n = Number(e.getRightValue(t)),
                    a = e.end - i;
                ...
                ut.each(e.data.datasets, function (a, r) {
                    if (e.isDatasetVisible(r)) {
                        ...
                        ut.each(a.data, function (e, a) {
                            var r = Number(t.getRightValue(e));
                            isNaN(r) ||
                                o.data[a].hidden ||
    ...
    function Zi(t, e) {
        ...
        return (
            ...
            ut.isFinite(o) ||
                (o = typeof r === "string" ? i.parse(o, r) : i.parse(o)),
            o !== null
                ? Number(o)
                : (a ||
                      typeof r !== "function" ||
    ...
    function $i(t, e) {
        ...
        return n === null
            ? n
            : (i.round && (n = Number(t._adapter.startOf(n, i.round))), n);
    }
    function Xi(t) {
    ...
    function Ki(t, e, i, n) {
        ...
        for (
            d ||
                ...
                h &&
                    ((g = Number(r.startOf(g, "isoWeek", h))),
                    (m = Number(r.startOf(m, "isoWeek", h)))),
                g = Number(r.startOf(g, h ? "day" : l)),
                (m = Number(r.startOf(m, h ? "day" : l))) < i &&
                    (m = Number(r.add(m, 1, l))),
                a = g,
                c &&
                    u &&
                    !h &&
                    !s.round &&
                    ((a = Number(r.startOf(a, u))),
                    (a = Number(r.add(a, ~~((g - a) / (f.size * d)) * d, l))));
            a < m;
            a = Number(r.add(a, d, l))
        )
            p.push(Number(a));
        return p.push(Number(a)), p;
    }
    var Ji = fi.extend({
            initialize: function () {
            ...
            determineDataLimits: function () {
                ...
                m.length &&
                    ...
                    (h = $i(o, u.min) || h),
                    (c = $i(o, u.max) || c),
                    (h = h === Ei ? Number(l.startOf(Date.now(), d)) : h),
                    (c = c === Hi ? Number(l.endOf(Date.now(), d)) + 1 : c),
                    (o.min = Math.min(h, c)),
                    ...
                    (function (t, e, i) {
                        ...
                        for (n = 0, a = e.length; n < a; ++n)
                            (r = e[n]),
                                (o =
                                    Boolean(i) &&
                                    r === Number(t._adapter.startOf(r, i))),
            ...
            ((function (t, e) {
                t.exports = (function () {
                    ...
                    function x(t) {
                        return (
                            t instanceof b ||
                            (t != null && t._isAMomentObject != null)
                        );
                    }
                    function _(t) {
                    ...
                    B("Y", 0, 0, function () {
                        ...
                        ft("YYYY", function (t, e) {
                            e[pt] =
                                t.length === 2 ? n.parseTwoDigitYear(t) : k(t);
                        }),
                        ft("YY", function (t, e) {
                    ...
                    (Ct = Array.prototype.indexOf
                        ...
                        ft(["MMM", "MMMM"], function (t, e, i, n) {
                            ...
                            a != null ? (e[vt] = a) : (f(i).invalidMonth = t);
                        });
                    var Ft = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
                        Rt =
                    ...
                    B("w", ["ww", 2], "wo", "week"),
                        ...
                        gt(["dd", "ddd", "dddd"], function (t, e, i, n) {
                            ...
                            a != null ? (e.d = a) : (f(i).invalidWeekday = t);
                        }),
                    ...
                    B("H", ["HH", 2], 0, "hour"),
                        ...
                        B("hmm", 0, 0, function () {
                            return (
                                String(te.apply(this)) + N(this.minutes(), 2)
                            );
                        }),
                        B("hmmss", 0, 0, function () {
                            return (
                                String(te.apply(this)) +
                                N(this.minutes(), 2) +
                                N(this.seconds(), 2)
                            );
                        }),
                        B("Hmm", 0, 0, function () {
                            return String(this.hours()) + N(this.minutes(), 2);
                        }),
                        B("Hmmss", 0, 0, function () {
                            return (
                                String(this.hours()) +
                        ...
                        return (
                            i &&
                                ...
                                f(t)._overflowDayOfYear &&
                                    (e < pt || e > yt) &&
                                    (e = yt),
                                f(t)._overflowWeeks && e === -1 && (e = wt),
                                f(t)._overflowWeekday && e === -1 && (e = Mt),
                                (f(t).overflow = e)),
                            t
                        );
                    }
                    ...
                    function we(t) {
                        ...
                        if (l) {
                            ...
                            if (!n && r != null) return void (t._isValid = !1);
                            if (l[4]) {
                                if (!ye.exec(l[4]))
                    ...
                    function Re(t, e) {
                        var i, n;
                        if (
                            (e.length === 1 && a(e[0]) && (e = e[0]), !e.length)
                        )
                            return Ie();
                    ...
                    function We(t) {
                        ...
                        (this._isValid = (function (t) {
                            ...
                            (this._milliseconds =
                                ...
                                6e4 * l +
                                1e3 * s * 60 * 60),
                            (this._days = Number(o) + 7 * r),
                            (this._months = Number(a) + 3 * n + 12 * i),
                            (this._data = {}),
                            (this._locale = ce()),
                            this._bubble();
                    }
                    ...
                    function ei(t) {
                        ...
                        return void 0 === t
                            ? this._locale._abbr
                            : ((e = ce(t)) != null && (this._locale = e), this);
                    }
                    ...
                    (bi.add = Je),
                        ...
                        (bi.isLocal = function () {
                            return Boolean(this.isValid()) && !this._isUTC;
                        }),
                    ...
                    function Mi(t, e, i, n) {
                        ...
                        var a,
                            r = ce(),
                            o = t ? r._week.dow : 0;
                        if (i != null) return ki(e, (i + o) % 7, n, "day");
                        var l = [];
                        for (a = 0; a < 7; a++)
                    ...
                    (_i.calendar = function (t, e, i) {
                        ...
                        (_i.isPM = function (t) {
                            return String(t).toLowerCase().charAt(0) === "p";
                        }),
                    ...
                    return (
                        ...
                        (Qi.humanize = function (t) {
                            ...
                            return (
                                t && (i = e.pastFuture(Number(this), i)),
                                e.postformat(i)
                            );
                        }),
                        (Qi.toISOString = Ji),
                        ...
                        (n.updateLocale = function (t, e) {
                            if (e != null) {
                                ...
                                oe[t] != null &&
                                    (oe[t].parentLocale != null
                                        ? (oe[t] = oe[t].parentLocale)
                                        : oe[t] != null && delete oe[t]);
                            return oe[t];
                        }),
                        (n.locales = function () {
                            return D(oe);
    ...
    function on(t, e, i) {
        var n,
            ...
            r = a.fill;
        if (
            (void 0 === r && (r = Boolean(a.backgroundColor)),
            !1 === r || r === null)
        )
            return !1;
    ...
    ot._set("global", {
        legend: {
            ...
            onClick: function (t, e) {
                ...
                (a.hidden =
                    a.hidden === null ? !n.data.datasets[i].hidden : null),
                    n.update();
            },
            onHover: null,
            onLeave: null,
            ...
            if (i.display) {
                ...
                (e.fillStyle = ut.valueOrDefault(
                    ...
                    t.isHorizontal()
                        ...
                        : ((a = i.position === "left" ? h + l : f - l),
                          (r = d + (c - d) / 2),
                          (n = c - d),
                          (u = Math.PI * (i.position === "left" ? -0.5 : 0.5))),
                    e.save(),
                    e.translate(a, r),
                    e.rotate(u),
                    (e.textAlign = "center"),
    ...
    (function () {
        ...
        (ut.where = function (t, e) {
            ...
            (ut._getParentNode = function (t) {
                var e = t.parentNode;
                return (
                    e && e.toString() === "[object ShadowRoot]" && (e = e.host),
                    e
                );
            }),
    ...
    var Cn = ai;
    return (
        typeof window !== "undefined" && (window.Chart = ai),
        (ai.Chart = ai),
