odoo.define(
    ...
    function (require) {
        ...
        var KsGraphPreview = AbstractField.extend({
            ...
            cssLibs: ["/ks_dashboard_ninja/static/libs/css/Chart.min.css"],
            ...
            _render: function () {
                ...
                if (
                    ...
                    this.recordData.ks_dashboard_item_type !== "ks_to_do"
                ) {
                            ...
                            ticks: {
                                ...
                                callback: function (value, index, values) {
                                    ...
                                    return KsGlobalFunction._onKsGlobalFormatter(
                                        value,
                                        self.recordData.ks_data_format,
                                        self.recordData.ks_precision_digits
                                    );
                                },
                            },
                        },
                                    ...
                                    let percentage =
                                        sum === 0
                                            ...
                                            : ((value * 100) / sum).toFixed(2) +
                                              "%";
                                    if (
                                        self.recordData.ks_data_label_type ==
                                        "value"
                                    ) {
                                        percentage = value;
                                    }
