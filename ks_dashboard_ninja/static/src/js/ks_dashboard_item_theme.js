odoo.define(
    "ks_dashboard_ninja_list.ks_dashboard_item_theme",
    function (require) {
        "use strict";
        ...
        var KsDashboardTheme = AbstractField.extend({
            ...
            events: _.extend({}, AbstractField.prototype.events, {
                "click .ks_dashboard_theme_input_container":
                    "ks_dashboard_theme_input_container_click",
            }),
            ...
            _render: function () {
                ...
                if (this.mode === "readonly") {
                    this.$el
                        .find(".ks_dashboard_theme_view_render")
