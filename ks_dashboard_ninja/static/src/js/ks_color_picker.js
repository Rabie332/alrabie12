odoo.define("ks_dashboard_ninja_list.ks_color_picker", function (require) {
    ...
    var KsColorPicker = AbstractField.extend({
        ...
        jsLibs: ["/ks_dashboard_ninja/static/libs/js/spectrum.js"],
        cssLibs: ["/ks_dashboard_ninja/static/libs/css/spectrum.css"],
        ...
        _ksOnOpacityChange: function (event) {
            this._setValue(
                this.value.split(",")[0].concat("," + event.currentTarget.value)
            );
        },
