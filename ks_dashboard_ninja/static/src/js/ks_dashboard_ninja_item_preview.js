odoo.define(
    ...
    function (require) {
        ...
        var KsItemPreview = AbstractField.extend({
            ...
            ksNumColombianFormatter: function (
                num,
                digits,
                ks_precision_digits
            ) {
            ...
            _render: function () {
                ...
                switch (field.ks_layout) {
                    case "layout1":
                        $val = $(
                            QWeb.render("ks_db_list_preview_layout1", item_info)
                        );
                        $val.css({
                    ...
                    case "layout2":
                        $val = $(
                            QWeb.render("ks_db_list_preview_layout2", item_info)
                        );
                    ...
                    case "layout3":
                        $val = $(
                            QWeb.render("ks_db_list_preview_layout3", item_info)
                        );
                        $val.css({
                            "background-color": ks_rgba_background_color,
                            color: ks_rgba_font_color,
                    ...
                    case "layout4":
                        $val = $(
                            QWeb.render("ks_db_list_preview_layout4", item_info)
                        );
                    ...
                    case "layout5":
                        $val = $(
                            QWeb.render("ks_db_list_preview_layout5", item_info)
                        );
                        $val.css({
                            "background-color": ks_rgba_background_color,
                            color: ks_rgba_font_color,
                    ...
                    case "layout6":
                        ...
                        $val = $(
                            QWeb.render("ks_db_list_preview_layout6", item_info)
                        );
                        $val.css({
                            "background-color": ks_rgba_background_color,
                            color: ks_rgba_font_color,
