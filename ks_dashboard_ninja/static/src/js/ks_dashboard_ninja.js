odoo.define("ks_dashboard_ninja.ks_dashboard", function (require) {
    ...
    var KsDashboardNinja = AbstractAction.extend({
        ...
        cssLibs: [
            "/ks_dashboard_ninja/static/libs/css/Chart.css",
            "/ks_dashboard_ninja/static/libs/css/Chart.min.css",
        ],
            ...
            if (state.context.ks_reload_menu) {
                if (odoo.session_info.server_version == "14.0+e") {
                    this.trigger_up("ks_reload_menu_data_enterprise", {
                        ks_menu: state.context.ks_top_menu_id,
                    });
        ...
        on_attach_callback: function () {
            ...
            $.when(self.ks_fetch_items_data()).then(function (result) {
                ...
                if (self.ks_dashboard_data.ks_item_data) {
                    ...
                    odoo.session_info.user_context.gridstack_config =
                        self.ks_get_current_gridstack_config();
                }
            });
        },
        ...
        ksOnLayoutSelection: function (layout_id) {
            ...
            _(this.gridstackConfig).each((x, y) => {
                self.grid.update(
                    self.$el.find(".grid-stack-item[gs-id=" + y + "]")[0],
                    { x: x.x, y: x.y, w: x.w, h: x.h, autoPosition: false }
                );
            });
        ...
        start: function () {
            ...
            return this._super().then(function () {
                var update_notification_ids = false;
                var msg = false;
                self.call(
                    "bus_service",
                    "onNotification",
        ...
        ksRenderDashboard: function () {
            ...
            var dash_name = $(
                'ul[id="ks_dashboard_layout_dropdown_container"] li[class="ks_dashboard_layout_event ks_layout_selected"] span'
            ).text();
                ...
                if (self.grid) {
                    if (items[i].ks_dashboard_item_type === "ks_tile") {
                        ...
                        if (items[i].id in self.gridstackConfig) {
                            ...
                            self.grid.addWidget($(item_view)[0], {
                        ...
                        if (items[i].id in self.gridstackConfig) {
                            self.grid.addWidget($kpi_preview[0], {
                                x: self.gridstackConfig[items[i].id].x,
                                y: self.gridstackConfig[items[i].id].y,
                                w: self.gridstackConfig[items[i].id].w,
                                h: self.gridstackConfig[items[i].id].h,
        ...
        _renderGraph: function (item) {
            ...
            var ksLayoutGridId = $(self.$el[0])
                .find(".ks_layout_selected")
                .attr("data-ks_layout_id");
            if (ksLayoutGridId && ksLayoutGridId != "ks_default") {
                self.gridstackConfig = JSON.parse(
                    self.ks_dashboard_data.ks_child_boards[
                        parseInt(ksLayoutGridId)
                    ][1]
                );
            }
            parseInt(
        ...
        ksChartColors: function (
            ...
            if (palette !== "default") {
                ...
                for (var i = 0; i < setsCount; i++) {
                    ...
                    for (var j = 0; j < gradientKeys.length; j++) {
                        ...
                        if (gradientIndex === Number(gradientKey)) {
                            ...
                            chartColors[i] =
                                ...
                                ")";
                            break;
                        } else if (gradientIndex < Number(gradientKey)) {
            ...
            if (ksChartFamily == "circle") {
                    ...
                    title: function (tooltipItem, data) {
                        ...
                        if (ks_selection === "monetary") {
                            ...
                            k_amount = field_utils.format.float(
                                k_amount,
                                Float64Array,
                                { digits: [0, item.ks_precision_digits] }
                            );
                            return (
                                data.datasets[tooltipItem[0].datasetIndex]
                                    .label +
                ...
                if (
                    ...
                    options.rotation = Number(Math.PI);
                    options.circumference = Number(Math.PI);
                }
                    ...
                    if ($(evt.target).parent().data().last_seq !== sequence) {
                        self._rpc({
                            ...
                            if (result.ks_list_view_data) {
                                ...
                                self.ks_dashboard_data.ks_item_data[
                                    item_id
                                ].ks_list_view_data = result.ks_list_view_data;
                                self.ks_dashboard_data.ks_item_data[
                                    item_id
                                ].ks_list_view_type = result.ks_list_view_type;
                                self.ks_dashboard_data.ks_item_data[
                                    item_id
                                ].ks_dashboard_item_type = "ks_list_view";
                                self.ks_dashboard_data.ks_item_data[
                                ...
                                self.ks_dashboard_data.ks_item_data[
                                    item_id
                                ].ks_dashboard_item_type = result.ks_chart_type;
                                self.ks_dashboard_data.ks_item_data[
                                    item_id
                                ].isDrill = true;
                                if (
        ...
        ks_get_current_gridstack_config: function () {
            ...
            if (
                ...
                var items =
                    document.querySelector(".grid-stack").gridstack.el.gridstack
                        .engine.nodes;
            }
            var grid_config = {};
        ...
        renderKpi: function (item, grid) {
            ...
            if (
                ...
                var pre_acheive = pre_diffrence > 0;
        ...
        ksChartExportPdf: function (e) {
            ...
            var $ks_el = $(
                $(
                    self.$el.find(".grid-stack-item[gs-id=" + chart_id + "]")
        ...
        ksLoadMoreRecords: function (e) {
            ...
            this._rpc({
                ...
                self.ks_dashboard_data.ks_item_data[itemId].ks_list_view_data =
                    result.ks_list_view_data;
                var item_view = self.$el.find(
                    ".grid-stack-item[gs-id=" + item_data.id + "]"
                );
