        ...
        var db = {
            ...
            "account.tax": {
                ...
                json_friendly_compute_all: function (args) {
                    var tax = _.find(db["account.tax"].records, {
                        id: args[0][0],
                    });
                    var amount = args[1];
                    ...
                    for (
                        let i = 0;
                        i < tax.invoice_repartition_line_ids.length;
                        i++
                    ) {
                        var rep_ln = _.find(
            ...
            "account.analytic.account": {
                ...
                records: [
                    ...
                    {
                        id: 23,
                        display_name: "Data Import/Export Plugin - Delta PC",
                    },
            ...
            "account.reconciliation.widget": {
                ...
                process_bank_statement_line: function (args) {
                    ...
                    ids = ids.concat(
                        _.flatten(_.pluck(datas, "payment_aml_ids"))
                    );
                    ids = _.compact(ids);
                ...
                get_bank_statement_data: function () {
                    ...
                    results.lines = _.filter(Datas.used.data_widget, function (
                        w
                    ) {
                ...
                get_move_lines_for_manual_reconciliation: function (args) {
                    ...
                    var lines = Datas.used.move_lines_for_manual_reconciliation[
                        key
                    ]
                        .filter(function (line) {
                    ...
                    for (var i in datas) {
                        ...
                        for (var key in Datas.used
                            ...
                            Datas.used.move_lines_for_manual_reconciliation[
                                ...
                                function (mv_line) {
                                    return (
                                        data.mv_line_ids.indexOf(mv_line.id) ===
                                        -1
                                    );
                                }
                            );
...
odoo.define("account_reconciliation_widget.reconciliation_tests", function (
    require
) {
    "use strict";
    ...
    QUnit.module(
        ...
        function () {
            ...
            QUnit.test("Reconciliation basic rendering", async function (
                assert
            ) {
                assert.expect(10);
                ...
                await testUtils.dom.click(
                    widget.$(
                        '.o_notebook .nav-link[href*="notebook_page_create"]'
                    )
                );
                assert.strictEqual(
                    widget.$el.data("mode"),
                ...
                await testUtils.dom.click(
                    widget.$(
                        '.o_notebook .nav-link[href*="notebook_page_match_rp"]'
                    )
                );
                assert.strictEqual(
                    widget.$el.data("mode"),
            ...
            QUnit.test("Reconciliation fields", async function (assert) {
                ...
                await testUtils.dom.click(
                    widget.$(".accounting_view tfoot td:first")
                );
                await testUtils.dom.click(
                    widget.$(
                        '.o_notebook .nav-link[href*="notebook_page_create"]'
            ...
            QUnit.test("Reconciliation basic data", async function (assert) {
                ...
                assert.strictEqual(
                    widget.$('.match:first .mv_line .cell_right:contains(".")')
                        .length,
                    2,
                ...
                assert.ok(
                    clientAction.widgets[1].$(
                        ".match:first div.load-more a:visible"
                    ).length,
                    "should display the 'load more' button"
                );
                assert.equal(
                    clientAction.widgets[1]
                        .$(".match:first div.load-more span")
                        .text(),
                    3,
                ...
                assert.ok(
                    clientAction.widgets[0].$(
                        "caption button.btn-secondary:visible"
                    ).length,
                ...
                assert.ok(
                    clientAction.widgets[2].$(
                        "caption button.btn-primary:visible"
                    ).length,
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    assert.equal(
                        widget.$(
                            ".accounting_view tbody .cell_left .edit_amount"
                        ).length,
                        1,
                        "should display the edition pencil"
                    );
                    ...
                    assert.equal(
                        clientAction.widgets[1].$(
                            "caption button:disabled:visible"
                        ).length,
                        1,
                        "button should be disabled"
                    );
                    ...
                    await testUtils.dom.click(
                        widget.$("button.btn-primary:visible")
                    );
            ...
            QUnit.test("Reconciliation change partner", async function (
                assert
            ) {
                assert.expect(17);
            ...
            QUnit.test("Reconciliation create line", async function (assert) {
                ...
                testUtils.mock.intercept(clientAction, "do_action", function (
                    event
                ) {
                    assert.strictEqual(
                ...
                await testUtils.dom.click(
                    widget.$(".create .reconcile_model_create"),
                    {
                        allowInvisible: true,
                    }
                );
                ...
                await testUtils.dom.click(
                    widget.$(".create .reconcile_model_edit"),
                    {
                        allowInvisible: true,
                    }
                );
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    testUtils.mock.addMockEnvironment(clientAction, {
                        ...
                        mockRPC: function (route, args) {
                            if (args.method === "name_get") {
                                return def.then(
                                    this._super.bind(this, route, args)
                                );
                            }
                            return this._super(route, args);
                        },
                    ...
                    await testUtils.dom.click(
                        $(".modal tr.o_data_row:contains(502)")
                    );
                    assert.strictEqual(
                        widget.$(".create .create_account_id input").val(),
                        "101200 Account Receivable",
            ...
            QUnit.test("Reconciliation create line with taxes", async function (
                ...
                await testUtils.dom.click(
                    widget.$(".create .create_tax_id input")
                );
                ...
                await testUtils.dom.click(
                    widget.$('[name="tax_ids"] a.o_delete')
                );
                widget
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    await testUtils.dom.click(
                        widget.$(
                            ".accounting_view tbody .cell_account_code:first"
                        )
                    );
                    await testUtils.dom.click(
            ...
            QUnit.test("Reconciliation manual", async function (assert) {
                ...
                await testUtils.dom.click(
                    clientAction.$(
                        ".o_reconciliation_line:eq(1) .accounting_view"
                    )
                );
                await testUtils.dom.click(
                ...
                assert.strictEqual(
                    clientAction.$(".o_reconciliation_line:eq(1) tfoot tr")
                        .length,
                    0,
                ...
                assert.strictEqual(
                    clientAction.$(
                        ".o_reconciliation_line:eq(1) .o_reconcile:visible"
                    ).length,
                    1,
                ...
                assert.strictEqual(
                    clientAction.$(
                        ".o_reconciliation_line:eq(1) .o_validate:visible"
                    ).length,
                    1,
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    var $buttonReconcile = widget.$(
                        "button.o_reconcile:not(hidden)"
                    );
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    // Check that a create form is here
                    var writeOffCreate = widget.$(
                        "div.create .create_account_id"
                    );
            ...
            QUnit.test("Tax on account receivable", async function (assert) {
                ...
                testUtils.mock.addMockEnvironment(clientAction, {
                    ...
                    mockRPC: function (route, args) {
                        ...
                        if (args.method === "process_move_lines") {
                            var mv_line_ids = args.args[0][0].mv_line_ids.slice(
                                0
                            );
                ...
                await testUtils.dom.click(
                    $reconcileForm.find(".create_tax_id input")
                );
                ...
                var $newLines = widget.$(
                    "tr.mv_line[data-line-id^=createLine]"
                );
                var idx =
                    $($($newLines[0]).find("td")[3]).text().trim() ===
                    "dummy text"
                        ? 0
                        : 1;
                    ...
                    testUtils.addMockEnvironment(clientAction, {
                        ...
                        mockRPC: function (route, args) {
                            if (args.method === "process_bank_statement_line") {
                                ...
                                assert.deepEqual(
                                    new_aml_dicts[0].analytic_tag_ids,
                                    [[6, null, [1, 2]]]
                                );
                                assert.deepEqual(
                                    new_aml_dicts[1].analytic_tag_ids,
                                    [[6, null, [2]]]
                                );
                            }
                            return this._super(route, args);
