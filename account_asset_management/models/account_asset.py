...
class AccountAsset(models.Model):
    ...
    already_depreciated_amount_import = fields.Float(
        string="Depreciated Amount (Import)",
        help="""In case of an import from another software, you might need to
             ...
             This is the value that was already depreciated with entries
             not computed from this model""",
        default=0.0,
    )
