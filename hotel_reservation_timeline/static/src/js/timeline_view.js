/* global py */
/* Odoo  hotel_reservation_timeline
 * Copyright 2015 ACSONE SA/NV
 * Copyright 2016 Pedro M. Baeza <pedro.baeza@tecnativa.com>
 * License AGPL-3.0 or later (http://www.gnu.org/licenses/agpl). */

odoo.define("hotel_reservation_timeline.TimelineView", function (require) {
    "use strict";
    ...
    const TimelineRenderer = require("hotel_reservation_timeline.TimelineRenderer");
    const TimelineController = require("hotel_reservation_timeline.TimelineController");
    const TimelineModel = require("hotel_reservation_timeline.TimelineModel");
    ...
    var TimelineView = AbstractView.extend({
        ...
        icon: "fa-tasks",
        jsLibs: ["/hotel_reservation_timeline/static/libs/vis-timeline/vis-timeline-graph2d.js"],
        cssLibs: ["/hotel_reservation_timeline/static/libs/vis-timeline/vis-timeline-graph2d.css"],
        ...
        _preapre_vis_timeline_options: function (attrs) {
            return {
                ...
                stack: isNullOrUndef(attrs.stack) ? true : utils.toBoolElse(attrs.stack, true),
