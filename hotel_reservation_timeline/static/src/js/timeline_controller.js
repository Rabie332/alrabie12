odoo.define("hotel_reservation_timeline.TimelineController", function (require) {
    "use strict";
    ...
    const TimelineController = AbstractController.extend({
        ...
        update: function (params, options) {
            ...
            return $.when(
                ...
                }).then((data) => this.renderer.on_data_loaded(data, n_group_bys, defaults.adjust_window))
            );
        },
        ...
        _onMove: function (event) {
            ...
            if (this.date_delay && event_end) {
                const diff_seconds = Math.round((event_end.getTime() - event_start.getTime()) / 1000);
