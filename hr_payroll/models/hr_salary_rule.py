...
class HrSalaryRule(models.Model):
    ...
    note = fields.Text(string="Description")
    is_specific_bonus = fields.Boolean(
        string="Specific bonus",
        help="This rule is used for specific bonus like the End of the Year, "
        "which is used for specific payslip",
    )
    is_variable_bonus = fields.Boolean(
        string="Variable bonus",
        help="This rule will appear in the contract's allowances and you can set an "
        "amount for it. When you create a bonus with this rule you can set a "
        "percent to allowance's amount.",
    )
